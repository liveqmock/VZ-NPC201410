...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <c:if test="${user.userType == 'manager'}">
                    <li class="active"><a href="${context}/manager/users.html">用户管理</a></li>
                </c:if>
        ...
        <div class="col-md-10 col-sm-offset-2">
            ...
            <h1 class="page-header">用户管理（新建和修改网站后台管理系统的用户）</h1>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="modifyform">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="password" class="form-control" id="password_modify" name="password"
                                   placeholder="密码-不修改密码则无需填写">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
