...
<div class="row">
    ...
    <div class="col-md-10">
        <h3>相关内容列表 <a href="javascript:history.go(-1);" class="btn btn-primary btn-sm pull-right">返回</a></h3>
            ...
            <c:if test="${!empty documents && fn:length(documents) > 0 }">
                <c:forEach var="document" items="${documents}" varStatus="documentRow">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary btn-xs" action="viewlog" data-resourceType="Document"
                               data-entityId="${document.documentId }">日志</a>&nbsp;
                            <c:if test="${document.status == 'rejected' || document.status == 'submitted' }">
                                <a class="btn btn-primary btn-xs" action="modify" data-resourceType="Document"
                                   data-entityId="${document.documentId }">修改</a>&nbsp;
                                <a class="btn btn-primary btn-xs" action="remove"
                                   data-entityId="${document.documentId }">删除</a>&nbsp;
                            </c:if>

                            <c:if test="${document.status == 'ratified'}">
                                <a class="btn btn-primary btn-xs" action="publish" data-resourceType="Document"
                                   data-entityId="${document.documentId }">发布</a>&nbsp;
                            </c:if>
                        </td>
                    </tr>
            ...
            <c:if test="${!empty relateds && fn:length(relateds) > 0}">
                <c:forEach var="related" items="${relateds}" varStatus="relatedRow">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary btn-xs" action="viewlog" data-resourceType="ImageRelated"
                               data-entityId="${related.imageRelatedId }">日志</a>
                            <c:if test="${related.status == 'rejected' || related.status == 'submitted' }">
                                <a class="btn btn-primary btn-xs" action="modify" data-resourceType="ImageRelated"
                                   data-entityId="${related.imageRelatedId }">修改</a>
                                <a class="btn btn-primary btn-xs" action="remove"
                                   data-entityId="${related.imageRelatedId }">删除</a>
                            </c:if>

                            <c:if test="${related.status == 'ratified' }">
                                <a class="btn btn-primary btn-xs" action="publish" data-resourceType="ImageRelated"
                                   data-entityId="${related.imageRelatedId }">发布</a>
                            </c:if>
                        </td>
                    </tr>
                    <c:set var="rowIndex" value="${rowIndex + 1 }"/>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="imageRelatedForm" action="relateds/add.html"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="imageRelatedTitle" name="imageRelatedTitle"
                                   placeholder="标题"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="textarea" class="form-control" id="imageRelatedDescription"
                                   name="imageRelatedDescription" placeholder="描述"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="imageRelatedSequence"
                                   name="imageRelatedSequence" placeholder="次序"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
...
<div class="modal fade" id="imageRelatedModifyModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="imageRelatedModifyForm" action="relateds/modify.html"
                      enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="textarea" class="form-control" name="imageRelatedDescription"
                                   placeholder="描述"/>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="documentModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="documentForm" action="documents/add.html"
                      enctype="multipart/form-data">
                    <input type="hidden" name="congressId" value="${imageMain.congressId }"/>
                    <input type="hidden" name="imageMainId" value="${imageMain.imageMainId }"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" rows="3" name="paragraphContents"
                                      placeholder="段落文字"></textarea>
                        </div>
                        <div class="col-sm-2">
...
<div class="modal fade" id="documentModifyModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="documentModifyForm" action="documents/modify.html"
                      enctype="multipart/form-data">
